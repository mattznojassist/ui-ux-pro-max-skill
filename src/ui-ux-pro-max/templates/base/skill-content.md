...
- **CLI-installed/self-contained skills:** `python3 {{SCRIPT_PATH}} ...`

If you're writing reusable instructions, keep the OpenClaw `{baseDir}` form alongside the platform-specific path so the skill works cleanly in both environments.
